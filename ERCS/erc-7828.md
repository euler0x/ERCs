...
Forward resolution (Interoperable Address -> Interoperable Name): Supported via the multichain address resolution standard defined in [EIP-2304], which uses coin types from [SLIP-0044] to resolve names for various chains, including the `eip155` namespace.
